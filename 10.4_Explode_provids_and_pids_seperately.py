...
test_folder = 'path/to/INTENSO/9_FINAL/data/machine_learning/two_class/distance/exploded_pid_provids/'

test_files = os.listdir(test_folder)

# checked files
checked_files = os.listdir('/path/to/9_FINAL/data/machine_learning/two_class/distance/exploded_seperately/')
...
for file in test_files:
    ...
    exploded_data = exploded_data.reset_index(drop=True)
        ...
        # export data
    exploded_data.to_csv('path/to/9_FINAL/data/machine_learning/two_class/distance/exploded_seperately/'+file, sep=";")
