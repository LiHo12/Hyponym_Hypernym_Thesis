...
types = pd.read_csv('/path/to/9_FINAL/data/matches/types_matches_wo_duplicates.csv', sep=";")
del types['Unnamed: 0']
...
for file in pids:
    ...
    all_data.to_csv('/path/to/9_FINAL/data/matches_pids/types/types_' + file, sep=";")

merged_pids_folder = '/path/to/9_FINAL/data/matches_pids/types/'
...
all_merged_pids.to_csv('/path/to/9_FINAL/data/matches_pids/types_with_pid.csv', sep=";")
