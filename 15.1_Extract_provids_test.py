...
# test
# get appended files
fold_folder = '/path/to/9_FINAL/data/machine_learning/two_class/distance_test/modifications/'
files_all = os.listdir(fold_folder)

folder_out = '/path/to/9_FINAL/data/machine_learning/two_class/distance_test/Extract_provids/'
