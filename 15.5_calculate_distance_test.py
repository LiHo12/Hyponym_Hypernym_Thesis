...
# get all folders
folder_in = '/path/to/9_FINAL/data/machine_learning/two_class/distance_test/merged_with_contexts_'

# initialize empty array to check for calculated files
checked_files = []

# folder out
data_out = '/path/to//9_FINAL/data/machine_learning/two_class/distance_test/calculated_distance_'
...
for i in range(0,10) :
    ...
    # folder_out
    folder_out = str(i).join([data_out, '/'])
